# Output Repository for Load-Wash-Elute Simulation with CADET

This repository stores the simulation results for RDM-Example **Load-Wash-Elute**. `CADET-RDM` automatically tracks all simulations that are started by running `main.py` from the corresponding project repository.
...
[Link to Project Repository](https://github.com/cadet/RDM-Example-Load-Wash-Elute)
